...
public class Heuristic {
    ...
    public void capacitatedClusterTSP(Data data){
        ...
        dataList = createTSPData(clustering.capacitatedKMeans(4), data);
    ...
    public ArrayList<Data> createTSPData(ArrayList<ArrayList<Point>> Clist, Data data){
        ArrayList<Data> dataList = new ArrayList<Data>();
        ...
        for(int i=0;i<Clist.size();i++){
                ...
                for(int j = 0;j<Clist.get(i).size();j++){
                    for(int k = 0;k<Clist.get(i).size();k++){
                        ...
                        dataTemp.distance[j][k] = data.distance[Clist.get(i).get(j).getID()][Clist.get(i).get(k).getID()];
